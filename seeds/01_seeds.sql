...
VALUES ('Eva Stanley', 'sebastianguerra@ymail.com', 'password'),
('Louisa Meyer', 'jacksonrose@hotmail.com', 'password1'),
('Dominic Parks', 'victoriablackwell@outlook.com', 'password2');
